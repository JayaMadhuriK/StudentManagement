    ...
    return(
        <Grid className="grid">
            <Grid className="grid-btn">
                <h1>Mtech</h1>
                <Button variant="contained" color="primary" size="large" onClick={()=>{navigate("/mtech")}} className="buttonnew"><AddIcon/>Add Record</Button>
                ...
                <Table aria-label='table'>
                    <TableHead> 
                        <TableRow>
                            ...
                            <TableCell align="center">DegreeCourse</TableCell>
                            ...
                            <TableCell align="center">MTECH_College</TableCell>
                            <TableCell align="center">Department</TableCell>
                            <TableCell align="center">MTECH_Specialization</TableCell>
                            <TableCell align="center">MTECH_NumberOF_Backlogs</TableCell>
                            <TableCell align="center">MTECH_CGPA</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
