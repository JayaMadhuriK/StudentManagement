...
const ViewValue1 = () =>{
  ...
  const handleDownload = async() =>{
      await axios.post('http://localhost:4000/download/download15');
  ...
  return(
      <Grid className="grid">
          <Grid className="grid-btn">
              ...
              <Button variant="contained" color="primary" size="large" onClick={()=>{navigate('/valueaddedyr1')}} className="buttonnew"><AddIcon/>Add Record</Button>
                          ...
                          >
                              ...
                              <TableCell align="center" scope="row" component="th">
                                  <Grid style={{display:'flex'}}>
                                      <Button variant="contained" size="small" onClick={()=>{navigate('/valueaddedyr1',{state:{student:student}})}}>Edit</Button>
                                      <Button variant="contained" style={{marginLeft:'10px'}} 
                                      onClick={()=>{
                                          axios.delete('http://localhost:4000/valueaddedYr1'+`/${student.Course_Code}`);
