...
const ValueAddedYr2 = () =>{
    ...
    const handleSubmit = async() => {
        let res = {};
        if(editData){
            await axios.put(`http://localhost:4000/valueaddedYr2/${student.Course_Code}`, registerRequestBody)
            .then((response) => {
            res = response;
            })
            .catch((error) => {
            ...
            await axios.post('http://localhost:4000/valueaddedYr2', registerRequestBody)
            .then((response) => {
                res = response;
            })
            .catch((error) => {
