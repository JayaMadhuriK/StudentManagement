...
const ValueAddedYr5 = () =>{
    ...
    const handleSubmit = async() => {
        let res = {};
        if(editData){
            await axios.put(`http://localhost:4000/valueaddedYr5/${student.Course_Code}`, registerRequestBody)
            .then((response) => {
            res = response;
            })
            .catch((error) => {
            ...
            await axios.post('http://localhost:4000/valueaddedYr5', registerRequestBody)
            .then((response) => {
                res = response;
            })
            .catch((error) => {
